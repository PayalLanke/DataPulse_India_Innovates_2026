...
const trendData = [
  { month: 'Jan', engagement: 62, voters: 11800 },
  { month: 'Feb', engagement: 68, voters: 11950 },
  { month: 'Mar', engagement: 76, voters: 12200 },
]

const predictions = [
  { text: 'Youth engagement likely to rise 8% in Q2', confidence: 87 },
  { text: 'B004 booth needs outreach focus', confidence: 92 },
]
        ...
        <Card className="p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold">2 active</p>
            </div>
          </div>
        </Card>
        <Card className="p-5">
